...
export default {
                ...
                {this.sourceData.map((rowItem, rowIndex) => {
                  return (
                    <tr
                      ...
                      row-key={
                        this.sourceData[rowIndex][this.getRowKey(rowItem)]
                      }
                      ...
                      {this.columns.map((columnsItem, columnsIndex) => {
                        return (
                          <td
                            ...
                            row-key={
                              this.getColumnKey(columnsItem) || columnsIndex
                            }
  ...
  methods: {
    ...
    _getCheckboxProps(rowItem) {
      // console.log(rowItem,'============');
      let prop = this.rowSelection.getCheckboxProps(rowItem);
      if (prop.disabled) {
        // console.log(
        //   "这个默认是disabled",
