...
var ReportElementCoatModule = /*#__PURE__*/function (_Module) {
  _inherits(ReportElementCoatModule, _Module);
  ...
  _createClass(ReportElementCoatModule, [{
    ...
    value: function handleChartData(chart) {
      ...
      if (!chartStyles.elementCoat) {
        chartStyles.elementCoat = _extends({}, defaultElementCoat);
      } else {
        // 对比 - 对象中的key并赋值初始值
        (0, _objectKeyCompare.recursion)(defaultElementCoat, _objectKeyCompare.compare, [], defaultElementCoat, chartStyles.elementCoat);
      }
    }
  }]);
...
exports.default = ReportElementCoatModule;