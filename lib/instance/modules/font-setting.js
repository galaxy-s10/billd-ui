...
var ReportFontSettingModule = /*#__PURE__*/function (_Module) {
  _inherits(ReportFontSettingModule, _Module);
  ...
  _createClass(ReportFontSettingModule, [{
    ...
    value: function handleChartData(chart) {
      ...
      if (!chartStyles.fontSetting) {
        chartStyles.fontSetting = _extends({}, defaultFontSetting);
      } else {
        // 对比 - 对象中的key并赋值初始值
        (0, _objectKeyCompare.recursion)(defaultFontSetting, _objectKeyCompare.compare, [], defaultFontSetting, chartStyles.fontSetting);
      }
    }
  }]);
...
exports.default = ReportFontSettingModule;