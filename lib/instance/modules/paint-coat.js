...
var ReportPaintCoatModule = /*#__PURE__*/function (_Module) {
  _inherits(ReportPaintCoatModule, _Module);
  ...
  _createClass(ReportPaintCoatModule, [{
    ...
    value: function handleChartData(chart) {
      ...
      if (!chartStyles.paintCoat) {
        chartStyles.paintCoat = _extends({}, defaultPaintCoat);
      } else {
        // 对比 - 对象中的key并赋值初始值
        (0, _objectKeyCompare.recursion)(defaultPaintCoat, _objectKeyCompare.compare, [], defaultPaintCoat, chartStyles.paintCoat);
      }
    }
  }]);
...
exports.default = ReportPaintCoatModule;