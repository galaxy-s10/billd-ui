...
var TableModules = /*#__PURE__*/function (_BaseChartModules) {
  ...
  function TableModules(chart, modules) {
    ...
    if (_options.default.download.pivotTable) {
    ...
    _this.styles.freezeHead.displayRow = true;
    _this.styles.freezeHead.displayColumn = true; // 透视图没有图表配色
    ...
    if (_this.data.dimension && _this.data.metric && _this.data.groupDimension) {
      _this.data.groupDimension.change = function (data) {
        return _this.initDimensionsAndMetric(_assertThisInitialized(_this), chart, data);
      };
    ...
    if (_this.data.sort) {
      _this.data.sort.moduleTypes = ['dimension', 'groupDimension'];
    }
