...
var _h3yun = _interopRequireDefault(require("./h3yun-2.0"));
...
var ReportGuide = /*#__PURE__*/function (_Vue) {
  ...
  function ReportGuide() {
    ...
    _this.prefixCls = 'h3-report-guide';
    _this.innerStep = 0;
    return _this;
  }
  ...
  _createClass(ReportGuide, [{
    ...
    value: function render(h) {
      ...
      var guideEl = this.container.cloneNode(true);
      var canvas = guideEl.querySelector('.h3-report-container__canvas');
      ...
      return h('div', {
        ...
        style: {
          ...
          bottom: "".concat(document.body.clientHeight - position.bottom, "px"),
          right: "".concat(document.body.clientWidth - position.right, "px")
        }
      }, [h('div', {
        class: {},
        style: {
...
__decorate([(0, _vuePropertyDecorator.Provide)()], ReportGuide.prototype, "innerStep", void 0);
