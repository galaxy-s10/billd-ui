...
var _index = _interopRequireDefault(require("../long-text/index"));
  ...
  _createClass(ReportElementWrap, [{
    ...
    value: function render() {
      ...
      return h("div", [this.getElementType == "long-text" ? h("long-text", {
        ...
        on: {
          "click-chart": function clickChart() {
            return _this.clickChart;
          },
          "register-refresh": function registerRefresh() {
            return _this.registerRefresh;
          },
          "update-charts-data": function updateChartsData() {
            return _this.updateChartsData;
          }
        }
      }) : h("chart-wrap", {
        attrs: {
...
__decorate([(0, _vuePropertyDecorator.Prop)({
  default: null
})], ReportElementWrap.prototype, "corpId", void 0);
...
ReportElementWrap = __decorate([(0, _vuePropertyDecorator.Component)({
  ...
  components: {
    ...
    LongText: _index.default
  }
})], ReportElementWrap);
var _default = ReportElementWrap;
